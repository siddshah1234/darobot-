...
import frc.robot.subsystems.breakit.BreakChassis;
import frc.robot.subsystems.breakit.BreakSubsystem;
...
public class RobotContainer {
  ...
  private BreakSubsystem breakSubsystem = new BreakSubsystem(
      new BreakChassis(
          new CANSparkMax(IndexingConstants.kLeftCanId, CANSparkLowLevel.MotorType.kBrushless),
          new CANSparkMax(IndexingConstants.kRightCanId, CANSparkLowLevel.MotorType.kBrushless)));
  ...
  private void configureBindings() {
    ...
    // BREAKER
    A.whileTrue(breakSubsystem.run(breakSubsystem::breakRobot));
    // X.whileTrue(breakSubsystem.run(breakSubsystem::aimUp));
    // Y.whileTrue(breakSubsystem.run(breakSubsystem::aimDown));

    A.and(B.negate()).whileTrue(breakSubsystem.run(breakSubsystem::breakRobot));
